...
import { brainwaveServices, navigation } from "../constants";
...
const Header = () => {
  ...
  return (
    ...
    >
      <div className="flex items-center px-2 lg:px-7.5 xl:px-1 max-lg:py-4">
        <a className="block w-[6rem] xl:mr-8 pl-2" href="#hero">
          <img
            src={logo}
            width={190}
            height={40}
